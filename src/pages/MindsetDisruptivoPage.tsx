    ...
    return (
        <div style={{ backgroundColor: '#050505', minHeight: '100vh', color: '#fff', fontFamily: 'Inter, sans-serif' }}>
            ...
            <section style={{
                ...
                <div style={{ maxWidth: '1400px', margin: '0 auto', position: 'relative', zIndex: 1, display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? '40px' : '80px', alignItems: 'center' }}>
                    <div style={{ flex: 1, width: '100%', textAlign: isMobile ? 'center' : 'left' }}>
                        ...
                        <motion.h1
                            ...
                            style={{ fontSize: isMobile ? '38px' : '110px', fontWeight: 900, lineHeight: isMobile ? 1.05 : 0.85, textTransform: 'uppercase', marginBottom: '20px', letterSpacing: isMobile ? '-1.5px' : '-4px' }}
                        >
                        ...
                        <motion.p
                            ...
                            style={{ fontSize: isMobile ? '15px' : '20px', color: '#888', maxWidth: '600px', margin: isMobile ? '0 auto 30px' : '0 auto 50px', lineHeight: 1.5 }}
                        >
                        ...
                        <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '20px', alignItems: 'center', justifyContent: isMobile ? 'center' : 'flex-start', width: '100%', maxWidth: isMobile ? '320px' : 'none', margin: isMobile ? '0 auto' : '0' }}>
                            <button style={{ backgroundColor: '#0011fd', color: '#fff', border: 'none', padding: isMobile ? '18px 40px' : '25px 60px', borderRadius: '15px', fontWeight: 900, fontSize: '18px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '15px', width: isMobile ? '100%' : 'auto' }}>
                                ABRIR LIVRO <Play fill="#fff" size={20} />
                            </button>
                            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: isMobile ? 'center' : 'flex-start' }}>
                    ...
                    <div style={{ flex: 0.8, position: 'relative', display: 'flex', justifyContent: 'center', width: '100%' }}>
                        <motion.div
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                style={{ position: 'absolute', top: '10%', right: isMobile ? '-10px' : '-15%', backgroundColor: '#fff', color: '#000', padding: isMobile ? '10px 15px' : '20px', borderRadius: '20px', boxShadow: '0 20px 40px rgba(0,0,0,0.3)', width: isMobile ? '140px' : '180px' }}
                            >
                                ...
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    ...
                                    <span style={{ fontSize: isMobile ? '12px' : '14px', fontWeight: 900 }}>+42 Membros</span>
                                </div>
                            </motion.div>
                        </motion.div>
                    </div>
            ...
            <section style={{ padding: isMobile ? '40px 15px' : '80px 40px', backgroundColor: '#080808' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'repeat(3, 1fr)', gap: '20px' }}>

                        {/* A. Current Mission */}
                        <div style={{ gridColumn: isMobile ? 'auto' : 'span 2', backgroundColor: '#0f0f0f', borderRadius: '40px', padding: isMobile ? '30px 20px' : '50px', border: '1px solid rgba(255,255,255,0.05)', position: 'relative', overflow: 'hidden' }}>
                            ...
                            <div style={{ position: 'relative', zIndex: 1 }}>
                                ...
                                <h2 style={{ fontSize: isMobile ? '24px' : '48px', fontWeight: 900, marginBottom: '20px' }}>LEIA AS PÁGINAS 126 A 150</h2>
                                <p style={{ color: '#888', fontSize: '16px', marginBottom: isMobile ? '30px' : '40px', maxWidth: '500px' }}>Tópico Hoje: <strong style={{ color: '#fff' }}>"O Efeito Dominó"</strong>. Como uma pequena ação gera um impacto massivo a longo prazo.</p>

                                <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: '15px', marginBottom: '30px' }}>
                                    <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', padding: '15px 30px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                        <div style={{ fontSize: '10px', color: '#666', fontWeight: 900, textTransform: 'uppercase', marginBottom: '5px' }}>Meta de Tempo</div>
                                        <div style={{ fontSize: '20px', fontWeight: 900 }}>45 MIN</div>
                                    </div>
                                    <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', padding: '15px 30px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                        <div style={{ fontSize: '10px', color: '#666', fontWeight: 900, textTransform: 'uppercase', marginBottom: '5px' }}>Dificuldade</div>
                                        <div style={{ fontSize: '20px', fontWeight: 900, color: '#f83821' }}>ALTA</div>
                                    </div>
                                </div>

                                <button style={{ backgroundColor: '#fff', color: '#00', border: 'none', padding: '18px 40px', borderRadius: '15px', fontWeight: 900, fontSize: '16px', cursor: 'pointer', transition: 'all 0.3s', width: isMobile ? '100%' : 'auto' }}>
                                    MARCAR COMO LIDO
                                </button>
                            </div>
                        </div>
                        ...
                        <div style={{ backgroundColor: '#0011fd', borderRadius: '40px', padding: isMobile ? '30px 20px' : '50px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            ...
            <section style={{ padding: isMobile ? '60px 15px' : '100px 40px' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', alignItems: isMobile ? 'flex-start' : 'center', gap: '20px', marginBottom: isMobile ? '30px' : '60px' }}>
                        <div>
                            <h2 style={{ fontSize: isMobile ? '28px' : '42px', fontWeight: 900, textTransform: 'uppercase' }}>Cronograma de Execução</h2>
                            <p style={{ color: '#888' }}>Mantenha o ritmo. Distração é o inimigo número 1.</p>
                        </div>
                        <div style={{ backgroundColor: '#111', padding: '15px 30px', borderRadius: '15px', display: 'flex', alignItems: 'center', gap: '20px', border: '1px solid rgba(255,255,255,0.05)', width: isMobile ? '100%' : 'auto', boxSizing: 'border-box' }}>
                            <div style={{ textAlign: isMobile ? 'left' : 'right', flex: 1 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '15px' }}>
                        {dailyReadingPlan.map((item, idx) => (
                            ...
                            >
                                <div style={{ width: isMobile ? 'auto' : '80px', fontSize: '24px', fontWeight: 900, color: item.status === 'done' ? '#666' : '#fff' }}>D{item.day}</div>
                                <div style={{ flex: 1 }}>
                                    <div style={{ fontSize: isMobile ? '16px' : '20px', fontWeight: 900, textTransform: 'uppercase', marginBottom: '5px', color: item.status === 'done' ? '#666' : '#fff' }}>{item.topic}</div>
                                    <div style={{ fontSize: '12px', color: '#666', fontWeight: 900 }}>PÁGINAS: {item.pages}</div>
                                </div>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '20px', justifyContent: isMobile ? 'flex-start' : 'flex-end' }}>
                                    {item.status === 'done' ? (
                                        <div style={{ color: '#0011fd', display: 'flex', alignItems: 'center', gap: '8px', fontWeight: 900 }}>
                                            <CheckCircle size={20} /> FINALIZADO
                                        </div>
                                    ) : item.status === 'current' ? (
                                        <div style={{ backgroundColor: '#0011fd', color: '#fff', padding: '10px 25px', borderRadius: '50px', fontSize: '12px', fontWeight: 900, width: isMobile ? '100%' : 'auto', textAlign: 'center' }}>LEITURA ATIVA</div>
                                    ) : (
                                        <div style={{ border: '1px solid rgba(255,255,255,0.1)', color: '#444', padding: '10px 25px', borderRadius: '50px', fontSize: '12px', fontWeight: 900, width: isMobile ? '100%' : 'auto', textAlign: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>BLOQUEADO <Lock size={12} /></div>
                                    )}
                                </div>
                            </motion.div>
                        ))}
            ...
            <section style={{ padding: isMobile ? '60px 15px' : '80px 40px', backgroundColor: '#0a0a0a', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: 'space-between', alignItems: isMobile ? 'flex-start' : 'center', gap: '20px', marginBottom: isMobile ? '30px' : '50px' }}>
                        <div>
            ...
            <section style={{ padding: isMobile ? '60px 15px' : '100px 40px', backgroundColor: '#050505' }}>
                <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: isMobile ? 'repeat(2, 1fr)' : 'repeat(4, 1fr)', gap: isMobile ? '15px' : '30px' }}>

                        <div style={{ backgroundColor: '#111', padding: isMobile ? '25px 15px' : '40px', borderRadius: '35px', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <div style={{ color: '#0011fd', marginBottom: '20px' }}><Users size={24} /></div>
                            <div style={{ fontSize: isMobile ? '24px' : '32px', fontWeight: 900 }}>{currentBook.stats.students}</div>
                            <div style={{ fontSize: '10px', color: '#666', fontWeight: 900, textTransform: 'uppercase' }}>ALUNOS NO PROGRAMA</div>
                        </div>

                        <div style={{ backgroundColor: '#111', padding: isMobile ? '25px 15px' : '40px', borderRadius: '35px', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <div style={{ color: '#f83821', marginBottom: '20px' }}><Trophy size={24} /></div>
                            <div style={{ fontSize: isMobile ? '24px' : '32px', fontWeight: 900 }}>{currentBook.stats.completionRate}</div>
                            <div style={{ fontSize: '10px', color: '#666', fontWeight: 900, textTransform: 'uppercase' }}>TAXA DE CONCLUSÃO</div>
                        </div>

                        <div style={{ backgroundColor: '#111', padding: isMobile ? '25px 15px' : '40px', borderRadius: '35px', border: '1px solid rgba(255,255,255,0.05)' }}>
                            <div style={{ color: '#fff', marginBottom: '20px' }}><Clock size={24} /></div>
                            <div style={{ fontSize: isMobile ? '24px' : '32px', fontWeight: 900 }}>{currentBook.stats.avgDailyReading}</div>
                            <div style={{ fontSize: '10px', color: '#666', fontWeight: 900, textTransform: 'uppercase' }}>MEDIA DE LEITURA</div>
                        </div>

                        <div style={{ backgroundColor: '#111', padding: isMobile ? '25px 15px' : '40px', borderRadius: '35px', border: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                            <div style={{ textAlign: 'center' }}>
                                <div style={{ color: '#0011fd', marginBottom: '10px' }}><Activity size={32} /></div>
                                <span style={{ fontWeight: 900, fontSize: '12px', color: '#fff' }}>VER FULL STATS</span>
                            </div>
                        </div>
            ...
            >
                <div style={{
                    ...
                    <div style={{ width: isMobile ? '36px' : '45px', height: isMobile ? '36px' : '45px', backgroundColor: '#0011fd', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                        <Brain color="#fff" size={isMobile ? 18 : 24} />
                    </div>
                    <div>
                        <div style={{ fontSize: isMobile ? '12px' : '14px', fontWeight: 900 }}>GUIA DISRUPTIVO</div>
                        <div style={{ fontSize: '9px', color: '#666', fontWeight: 900 }}>PERGUNTE SOBRE O LIVRO</div>
                    </div>
